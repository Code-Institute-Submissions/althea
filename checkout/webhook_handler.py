    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                ...
                profile.province = shipping_details.address.state,
                profile.town_or_city = shipping_details.address.city,
                profile.street_address = shipping_details.address.line2,
                profile.house_number = shipping_details.address.line1,
